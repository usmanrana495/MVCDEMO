...
<div class="nave_pati">
<a style="text-decoration:none" href="home.php"><div class="nave_home">Home</div></a>
<a style="text-decoration:none" href="search.php"><div class="nave_search">Search Ads</div></a>
...
<br><br>
 <div class="pagy_body_header1">Sign Up</div>
<br><br>
...
<form action="signup" method="post">
  ...
  <input class="reg2_textfield" type="text" style="text-align: centre" name="fname" id="textfield" placeholder="First Name" onsubmit="return validateForm()"  required/><br>
   <input class="reg2_textfield" type="text" style="text-align: center" name="lname" id="textfield" placeholder="Last Name " onsubmit="return validateForm()" required/><br><br>

   <input class="reg2_textfield"  type="password" style="text-align: left" name="password" id="textfield" placeholder="Password" required/><br><br>
    <input  class="reg2_textfield" type="password" style="text-align: left" name="cpassword" id="textfield" placeholder="Confirm Password" required/><br><br>

  <input class="reg2_textfield" type="text" size="11" style="text-align: left" name="phone" id="textfield" placeholder="Phone No." required/><br><br>
       <input class="reg2_textfield" type="text" style="text-align: left" name="email" id="textfield" placeholder="Email" required/><br><br>

     <input class="reg2_textfield"  type="text" style="text-align: left" name="state" id="textfield" placeholder="State" required/><br><br>
     
       <div class="reg2_textfield">

   
    	  <label for="select">Choose a City: </label>
	   	<select class="reg_select_cata" name="city"  size="1"  >
   ...
   <input class="reg2_textfield" type="text" style="text-align: left" name="address" id="textfield" placeholder="Address" required/><br><br>
<input type="submit" class="reg2_textfield" value="Sign up">
</form> 
